...
const ProductCardSquare = ({ product }) => {
  ...
  return (
    ...
    <div className="bg-white border border-gray-100 rounded p-1.5 group flex flex-col items-center hover:border-green-500 hover:shadow-lg transition-all duration-300 w-full aspect-square relative overflow-hidden">
      ...
      <div className="w-full aspect-square flex items-center justify-center p-2 mb-1.5 relative">
        ...
        <div className="absolute top-2 right-2 flex flex-col gap-1.5 md:opacity-0 md:group-hover:opacity-100 transition duration-300 z-10">
          <button className="p-1.5 border border-gray-100 rounded-full bg-white hover:bg-green-50 text-gray-400 hover:text-green-600 shadow-sm">
      ...
      <div className="w-full text-center mt-auto px-1 pb-1">
        ...
        <div className="w-full mt-auto md:opacity-0 md:group-hover:opacity-100 transition duration-300">
          <button className="w-full bg-green-600 hover:bg-green-700 text-white text-[11px] font-semibold py-1.5 rounded flex items-center justify-center gap-1">
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
